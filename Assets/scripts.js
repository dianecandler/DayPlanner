...
$(document).ready(function () {
	...
	// commented out for test in non-standard hours - H for 24 hr, h for 12 hr - NEED TEXT BOX SELECTOR?
	let nowHour24 = moment().format('H');
	let nowHour12 = moment().format('h');

	// new material pulled from online search - looks like out homework solution so copied below

	// set times for tesitng after hours
	if (test) {
		nowHour24 = 13; //ask CJ about this
		nowHour12 = 1;
	}

	let $dateHeading = $('#navbar-subtitle'); //should swith this to "jumbotron"?
	...
	let storedPlans = JSON.parse(localStorage.getItem('storedPlans')); //CJ another option here?
